  ...
  issueCreated:
    ...
    steps:
      - name: Get NPM version
        ...
        with:
          url: https://registry.npmjs.org/iobroker.${packageName}
          method: GET
      - name: Create comment
        ...
        with:
          ...
          body: |
            ...
            1. Please make sure your topic is not covered in the [documentation](https://github.com/${user}/ioBroker.${packageName}/blob/${githubData.default_branch}/docs/en/README.md)
